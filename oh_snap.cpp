...
//*******************************************************************LAST BRANCH RESULT********************************************************
void last_branch_result_v4(uint64_t pc, uint8_t taken,uint64_t branch_target){
...
void O3_CPU::last_branch_result(uint64_t ip, uint8_t taken, uint64_t target)
{
    ...
    last_branch_result_gshare(ip,taken,target);
    last_branch_result_v4(ip,taken,target);
}
